  ...
  return (
    <>
      ...
      <div className="h-dvh w-full bg-[#0d0d0d] text-gray-400 font-sans selection:bg-white/10 overflow-hidden flex flex-col">
        ...
        <div className={cn(
          "relative sm:max-w-5xl mx-auto w-full transition-all duration-500 flex flex-col min-h-0 flex-1",
          currentView === 'lesson' ? "pt-2 pb-6 sm:pt-4 sm:pb-8 px-0 sm:px-6" : "py-4 sm:py-8 px-4 sm:px-6"
        )}>
          {isLoading ? (
