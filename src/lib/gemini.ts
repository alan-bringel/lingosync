...
12. **TRANSLATION STRICT FIDELITY — NEVER ADD EXTRA CONTENT**: The translation MUST contain ONLY the words that correspond to the English source text. NEVER add words, phrases, explanations, or clarifications that are not present in the English. For example:
...
10. **TRANSLATION STRICT FIDELITY — NEVER ADD EXTRA CONTENT**: The translation MUST contain ONLY the words that correspond to the English source text. NEVER add words, phrases, explanations, or clarifications that are not present in the English. For example:
    - English: "But the humans are tempted by this mysterious,"
    - CORRECT: "Mas os humanos são tentados por este misterioso,"
    - WRONG: "Mas os humanos são tentados por este misterioso personagem não humano," ❌ (added "personagem não humano")
    - English: "He is a just judge"
